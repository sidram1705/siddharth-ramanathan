  ...
  return (
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch reveal-up">
            ...
            <form action="https://getform.io/f/adrgdvva" method="POST" className="xl:pl-10 2xl:pl-20">
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Siddharth Ramanathan" className="text-field" />
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="name@example.com" className="text-field" />
